...
import { 
  Bell, LogOut, HelpCircle, Lock, LayoutDashboard, ShoppingBag, Users, Trophy, Settings, Loader2
} from 'lucide-react';
...
const App = () => {
  ...
  if (appMode === 'AUTH') return <AuthView onLogin={handleMockLogin} />;
          ...
          <main ref={mainContentRef} className="flex-1 overflow-y-auto p-4 lg:p-8 bg-[#F8F9FA] pb-24 lg:pb-10 scroll-smooth">
            {isLoading ? (
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    {currentView === 'SETTINGS' && <SettingsView user={currentUser} globalSettings={globalSettings} setGlobalSettings={setGlobalSettings} integrationConfig={integrationConfig} setIntegrationConfig={setIntegrationConfig} simulationMode={simulationMode} onSave={() => showToast('Configuración guardada', 'success')} onImportCatalog={() => {}} />}
                </div>
            )}
          </main>
